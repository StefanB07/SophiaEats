...
public class RestaurantRepository {
    ...
    public Collection<Restaurant> findAll() { return byName.values(); }
    public Optional<Restaurant> findByName(String name) { return Optional.ofNullable(byName.get(name)); }
    public Restaurant save(Restaurant r) { byName.put(r.getName(), r); return r; }
}
